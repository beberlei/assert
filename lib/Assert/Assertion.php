 ...
 * @method static void nullOrLength($value, $length, $message = null, $propertyPath, $encoding)
 * @method static void nullOrMinLength($value, $minLength, $message = null, $propertyPath, $encoding)
 * @method static void nullOrMaxLength($value, $maxLength, $message = null, $propertyPath, $encoding)
 * @method static void nullOrBetweenLength($value, $minLength, $maxLength, $message = null, $propertyPath, $encoding)
 * @method static void nullOrStartsWith($string, $needle, $message = null, $propertyPath, $encoding)
 * @method static void nullOrEndsWith($string, $needle, $message = null, $propertyPath, $encoding)
 * @method static void nullOrContains($string, $needle, $message = null, $propertyPath, $encoding)
 ...
 * @method static void allLength($value, $length, $message = null, $propertyPath, $encoding)
 * @method static void allMinLength($value, $minLength, $message = null, $propertyPath, $encoding)
 * @method static void allMaxLength($value, $maxLength, $message = null, $propertyPath, $encoding)
 * @method static void allBetweenLength($value, $minLength, $maxLength, $message = null, $propertyPath, $encoding)
 * @method static void allStartsWith($string, $needle, $message = null, $propertyPath, $encoding)
 * @method static void allEndsWith($string, $needle, $message = null, $propertyPath, $encoding)
 * @method static void allContains($string, $needle, $message = null, $propertyPath, $encoding)
