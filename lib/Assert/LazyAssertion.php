 ...
 * @method LazyAssertion betweenLength(int $minLength, int $maxLength, string $message = null, string $propertyPath = null, string $encoding = 'utf8') Assert that string length is between min,max lengths.
 ...
 * @method LazyAssertion keyExists(string|int $key, string $message = null, string $propertyPath = null) Assert that key exists in an array.
 * @method LazyAssertion keyIsset(string|int $key, string $message = null, string $propertyPath = null) Assert that key exists in an array/array-accessible object using isset().
 * @method LazyAssertion keyNotExists(string|int $key, string $message = null, string $propertyPath = null) Assert that key does not exist in an array.
 ...
 * @method LazyAssertion maxLength(int $maxLength, string $message = null, string $propertyPath = null, string $encoding = 'utf8') Assert that string value is not longer than $maxLength chars.
 ...
 * @method LazyAssertion notEmptyKey(string|int $key, string $message = null, string $propertyPath = null) Assert that key exists in an array/array-accessible object and its value is not empty.
